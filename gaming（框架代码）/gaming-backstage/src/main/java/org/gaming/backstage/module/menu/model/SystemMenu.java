 ...
 */
@Repository
@Table(name = "menu1_system", comment = "系统菜单，系统菜单>模块菜单>功能菜单", dbAlias = "backstage")
public class SystemMenu extends OneToManyRedisHashEntity {
	...
	public boolean sameWith(SystemMenu other) {
