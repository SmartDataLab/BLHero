 ...
 *
 */
public class LogAsyncDao<T extends AbstractEntity> extends LogBaseDao<T> implements IAsyncDao<T> {

	private IAsyncEntityMeta asyncMeta;
	
	private AsyncDaoPlugin<T> asyncDaoPlugin;
	
	public LogAsyncDao(DataBase dataBase, LogAsyncEntityMeta<T> entityMeta) {
