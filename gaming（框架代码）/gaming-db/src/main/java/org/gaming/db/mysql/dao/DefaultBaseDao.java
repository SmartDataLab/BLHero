...
import org.gaming.db.mysql.sql.DefaultSql;
...
public abstract class DefaultBaseDao<T extends AbstractEntity> extends OriginDao<T> {
	...
	protected static Logger logger = LoggerFactory.getLogger(DefaultBaseDao.class);
	
	private DefaultSql<T> sql;
	
	public DefaultBaseDao(DataBase dataBase, EntityMeta<T> entityMeta) {
