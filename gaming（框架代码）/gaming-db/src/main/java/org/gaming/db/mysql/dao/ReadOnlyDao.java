...
import org.gaming.db.orm.AliasEntityMeta;
...
public class ReadOnlyDao {
	...
	public static <U> List<U> queryObjects(DataBase dataBase, Class<U> clazz, String tableName, String where, Object... params) {
		String sql = "SELECT * FROM " + tableName + " " + where;
		return queryAliasObjects(dataBase, clazz, sql, params);
	}
	
	public static <U> List<U> queryAliasObjects(DataBase dataBase, Class<U> clazz, String sql, Object... params) {
	...
	public static <U> U queryAliasObject(DataBase dataBase, Class<U> clazz, String sql, Object... params) {
		List<U> result = queryAliasObjects(dataBase, clazz, sql, params);
		if(result.size() > 1) {
	...
	public static long count(DataBase dataBase, String tableName, String where, Object... params) {
		Connection connection = null;
		PreparedStatement statement = null;
		ResultSet rs = null;
