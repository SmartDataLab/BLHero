...
public abstract class OriginDao<T extends AbstractEntity> {
	...
	private static Logger logger = LoggerFactory.getLogger(OriginDao.class);
	 ...
	 * @param valueFormater
	 */
	public OriginDao(DataBase dataBase, EntityMeta<T> entityMeta) {
	...
	private void insertWithAutoId(T t) {
		...
		try {
			...
			connection = this.dataBase.getDataSource().getConnection();
	...
	public long count(String tableName, String where, Object... params) {
		return ReadOnlyDao.count(dataBase, tableName, where, params);
	}
	...
	public <U> List<U> queryAliasObjects(Class<U> clazz, String sql, Object... params) {
		return ReadOnlyDao.queryAliasObjects(dataBase, clazz, sql, params);
	}
	
	public <U> U queryAliasObject(Class<U> clazz, String sql, Object... params) {
		return ReadOnlyDao.queryAliasObject(dataBase, clazz, sql, params);
	}
	
	public List<T> queryObjects(String tableName, String where, Object... params) {
		String sql = "SELECT * FROM " + tableName + " " + where;
		return ReadOnlyDao.queryAliasObjects(dataBase, this.getEntityMeta().getClazz(), sql, params);
	}
