    ...
    <el-card>
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="heroId" label="英雄ID" min-width="150" />
          <el-table-column prop="thingId" label="英雄标识" min-width="150" />
          <el-table-column prop="thingName" label="英雄名称" min-width="200" />
...
import { heroFightingLogs } from '@/api/playerResourceLog'
    ...
    async handleInquire() {
      try {
        ...
        if (!this.serverText) {
          ...
          const result = await heroFightingLogs(query)
          this.total = result.data.data.count
          this.heroFightingData = result.data.data.data
        }
      } catch (error) {
        console.error(error)
