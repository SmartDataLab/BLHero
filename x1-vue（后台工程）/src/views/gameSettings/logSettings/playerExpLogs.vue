    ...
    <el-card>
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="oldLevel" label="原等级" min-width="150" />
          <el-table-column prop="currLevel" label="当前等级" min-width="150" />
          <el-table-column prop="thingId" label="物品标识" min-width="150" />
          <el-table-column prop="thingName" label="物品名称" min-width="200" />
          <el-table-column prop="delta" label="变化量" min-width="150" />
          <el-table-column prop="curr" label="变化后的当前量" min-width="150" />
...
import { playerExpLogs } from '@/api/playerResourceLog'
    ...
    async handleInquire() {
      try {
        ...
        if (!this.serverText) {
          ...
          const result = await playerExpLogs(query)
          this.total = result.data.data.count
          this.playerExpData = result.data.data.data
        }
      } catch (error) {
        console.error(error)
